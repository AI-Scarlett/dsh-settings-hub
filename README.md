...
当前插件版本为 `0.2.1`。通过 GitHub 安装时建议固定已公开回读的完整 40 位 Commit：

```text
github:AI-Scarlett/dsh-settings-hub#a91a65e939ca2435f1973eb17f8f33f1ee8a737d
```

- `0.2.1` 源码：功能检查、一次性 Profile E3 与 GitHub 三平台 CI 已通过；
- GitHub 固定源码：`a91a65e939ca2435f1973eb17f8f33f1ee8a737d` 的 manifest、Bundle Patch 与 Client 已公开回读；
- GitHub 标签：`v0.2.1` 指向上述源码 Commit；
